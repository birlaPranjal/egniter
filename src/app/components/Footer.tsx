      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <div className="flex space-x-4">
                <Link href="#" className="text-white hover:text-[#1849C6] transition-colors">
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">123 Creative Street</li>
              <li className="text-gray-400">Design District, CA 90210</li>
              <li className="text-gray-400">info@egniter.com</li>
        ...
        <div className="text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Egniter. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
