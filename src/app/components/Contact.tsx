            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="name" className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-white" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2">Email</label>
                  <input type="email" id="email" className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-white" />
                </div>
              </div>
              <div>
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">123 Creative Street, Design District, CA 90210</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-600/20 p-3 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">info@egniter.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-600/20 p-3 rounded-lg mr-4">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-800">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-blue-600/20 p-3 rounded-lg text-blue-500 hover:bg-blue-600/30 transition-colors">
